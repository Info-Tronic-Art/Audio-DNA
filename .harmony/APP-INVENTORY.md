...
Source: lane-6-io-api.md. 23 endpoints; all functional (`/api/set_bpm` wired Wave 0; `/api/resync` added s-rta-0925 -- manual Resync via `requestResync()`, message thread -> analysis thread).

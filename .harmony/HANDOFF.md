...
5. My handoff rewrite replaced a span by index and silently deleted 212 lines of history (incl. RIG
   MECHANICS); caught from the commit's deletion count, restored verbatim, and checked: 0 non-blank
   lines missing outside the two intentionally replaced blocks. Habit: diff-stat every doc rewrite.

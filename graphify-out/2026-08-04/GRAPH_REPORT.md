# Graph Report - RealTimeAudio  (2026-08-04)

## Corpus Check
- 281 files · ~433,239 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5289 nodes · 8480 edges · 287 communities (215 shown, 72 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 574 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57aa4361`
...
- KeyPress
- setComposition
- _discover_main_fullscreen_item
- getDeviceStatus
- .getComposition
- .setEffectFenceHook
- .setEffectPerformEdit
...
## Communities (287 total, 72 thin omitted)

### Community 0 - "MainComponent"
Cohesion: 0.01
Nodes (147): ApiServer, AudioDNALookAndFeel, AudioDNAMenuBar, AudioEngine, AudioReadoutPanel, BindingManager, BindingOverlay, BrowserPanel (+139 more)
...
Cohesion: 0.13
Nodes (23): AccessibilityPermissionError, AppNotFoundError, AXInspectorError, check_accessibility_permissions(), find_pid_by_name(), _get_ax_attribute(), _get_position(), _get_size() (+15 more)
...
Cohesion: 0.04
Nodes (51): Binding, ClipDeckResolver, ClipLayerResolver, ClipMediaHook, CompositionResolver, Deck, DeckActivateHook, DeckFenceHook (+43 more)
...
### Community 16 - "vector"
Cohesion: 0.21
Nodes (9): updateFeedbackBuffer, FullscreenQuad, draw, init, initialized_, release, vao_, vbo_ (+1 more)
...
Cohesion: 0.07
Nodes (35): ChromaExtractor, FFTProcessor, KeyDetector, LoudnessAnalyzer, MFCCExtractor, OnsetDetector, PitchTracker, kBlockSize (+27 more)
...
Cohesion: 0.11
Nodes (10): SpectralFeatures, atomic, FeatureBus, Thread, Array, Deck, Composition, vector (+2 more)
...
Cohesion: 0.11
Nodes (15): Image, GLuint, TextureManager, createFBOs, fboHeight_, fbos_, fboTextures_, fboWidth_ (+7 more)
...
Cohesion: 0.10
Nodes (21): EffectChain, FeatureBus, File, Image, mutex, OpenGLContext, OpenGLRenderer, OutputRenderer (+13 more)
...
Cohesion: 0.14
Nodes (33): Array, DeckState, EffectChain, FeatureBus, LoadStats, MappingCurve, MappingEngine, MappingSource (+25 more)
...
Cohesion: 0.12
Nodes (25): buildSourceParamControls, ClipInspector::ClipInspector(), getPreferredHeight, isInterestedInDragSource, itemDragEnter, itemDragExit, itemDropped, mouseDown (+17 more)

### Community 60 - "ax_inspector.py"
Cohesion: 0.13
Nodes (26): Any, AccessibilityPermissionError, AmbiguousButtonError, AppNotFoundError, AXPressError, ButtonNotFoundError, collapse_signalbar(), expand_signalbar() (+18 more)
...
Cohesion: 0.11
Nodes (17): DialogWindow, enterBindingMode, Component, function, Graphics, Rectangle, Tab, JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (+9 more)
...
Cohesion: 0.11
Nodes (22): ProgramEntry, unordered_map, FeatureSnapshot, File, GLint, OpenGLContext, OpenGLShaderProgram, String (+14 more)
...
### Community 89 - "Effect"
Cohesion: 0.05
Nodes (75): String, Effect, addParam, category_, dryWet_, Effect::Effect(), enabled_, name_ (+67 more)

### Community 90 - "EffectLibrary"
Cohesion: 0.16
Nodes (16): Effect, EffectDef, String, StringArray, unique_ptr, EffectLibrary, createEffect, defs_ (+8 more)

### Community 91 - "MappingEngine"
Cohesion: 0.11
Nodes (21): FeatureSnapshot, Mapping, Smoother, EffectChain, MappingEngine, addMapping, applyCurve, clearAll (+13 more)
...
Cohesion: 0.12
Nodes (17): MappingCurve, MappingSource, Mapping, curve, enabled, inputMax, inputMin, outputMax (+9 more)
...
### Community 106 - "Route"
Cohesion: 0.14
Nodes (13): Component, File, Image, MainComponent::imageReceived(), OutputRenderer::attachTo(), OutputRenderer::detach(), OutputRenderer::initShaders(), OutputRenderer::loadImage() (+5 more)
...
Cohesion: 0.06
Nodes (23): Configure the entire effect chain.          Disables all existing effects, then, Inject synthetic audio features into the FeatureBus.          Args:, Render a single frame and save it to disk.          Args:             output_pat, Get the current engine state (effects, FPS, etc.)., Controls Audio-DNA via the Eyes HTTP API., Reset all effects, clear images, restore defaults., Load a procedural source into the active clip.          Args:             source, Update parameters on the currently active source.          Args:             par (+15 more)

### Community 122 - "MacroBank"
Cohesion: 0.13
Nodes (11): Macro, Scope, array, SignalRegistry, MacroBank, kNumMacros, macros_, scope_ (+3 more)
...
Cohesion: 0.13
Nodes (21): BindableTarget, CellEdit, Clip, Command, Layer, optional, File, String (+13 more)
...
Cohesion: 0.10
Nodes (24): Event, _arm_watchdog(), _as_applescript_string(), _click_output_item(), _default_app_bundle(), _health_ok(), _is_ours(), _osascript() (+16 more)
...
### Community 159 - "._post"
Cohesion: 0.17
Nodes (12): Display, KeyPress, OutputComponent, DocumentWindow, JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR, OutputWindow, OutputWindow::closeButtonPressed(), OutputWindow::goFullscreenOnDisplay() (+4 more)
...
Cohesion: 0.17
Nodes (6): SignalRegistry, MouseEvent, Slider, ResettableSlider, defaultVal_, hasDefault_
...
Cohesion: 0.10
Nodes (26): _close_output_window(), _find_app_pids(), _find_output_windows(), _find_output_windows_any(), _onscreen_windows(), _pgrep(), _process_alive(), Whether a PID is still running (EPERM counts as alive). (+18 more)
...
Cohesion: 0.15
Nodes (22): _describe_pid_windows(), _discover_main_fullscreen_item(), main(), _measure(), _open_output_window(), _pick_main_fullscreen_item(), _preflight(), ProbeBlocked (+14 more)
...
### Community 226 - "queueCameraFrame"
Cohesion: 0.36
Nodes (7): EffectLibrary, addTestEffect(), EffectChain, File, String, vector, tempPresetFile()

### Community 235 - "setupColumnTriggers"
Cohesion: 0.40
Nodes (5): paint, paintSectionHeader, Graphics, Rectangle, String

### Community 239 - ".render_frame"
Cohesion: 0.67
Nodes (3): getTransitionShaderName, MixMode, String

## Knowledge Gaps
- **1630 isolated node(s):** `defs_`, `mappings_`, `smoothers_`, `lookAndFeel_`, `ringBuffer_` (+1625 more)
...
- **Why does `Clip` connect `Clip` to `FeedbackConfig`, `ClipInspector`, `ApiServer`, `Layer`, `SwapClipsCmd`, `operator==`, `ShaderManager`, `EffectScope`, `string`, `RecordPanel.cpp`, `ClipPositionSignal`, `MidiOutputHandler`, `ResettableSlider`, `UndoService.cpp`, `Deck`, `ClipInspector.cpp`, `Autopilot`, `ClipCell`, `test_downbeat_detector.cpp`, `TestSourceRegistry`, `ShaderManager.cpp`, `Effect`, `UndoService`, `MidiLearnOverlay.cpp`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `Renderer` connect `Renderer` to `SyphonOutput`, `AnalysisThread`, `VideoRecorder`, `vector`, `CompositorEngine`, `RecordPanel.cpp`, `TextureManager`, `EffectChainGLState`, `Renderer.cpp`, `EffectParam`, `Autopilot`, `ProceduralSource`, `function`, `addParam`, `ShaderManager.cpp`, `Composition`, `Deck`, `File`, `EffectLibrary`, `MappingEngine`, `SignalRegistry`, `.setPerTypeAutopilotConfig`, `SourceRegistry`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `EffectLibrary` connect `EffectLibrary` to `Renderer`, `FeedbackConfig`, `ApiServer`, `operator==`, `ISFShaderLoader.cpp`, `EffectScope`, `FXBrowser`, `EffectStackView`, `CompositorEngine`, `SetColumnCountCmd`, `RecordPanel.cpp`, `EffectsRackPanel`, `CaretOnlyComboBoxLookAndFeel`, `ResettableSlider`, `ClipInspector.cpp`, `getThumbnailBounds`, `ShaderManager.cpp`, `LayerInspector.cpp`, `MappingEngine`, `FeedbackProcessor`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **What connects `defs_`, `Output-window LEVEL probe — regression guard for the "black overlay on every Spa`, `Raised when the measurement cannot be performed (exit 2).` to the rest of the system?**

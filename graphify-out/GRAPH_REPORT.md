...
## Corpus Check
- 282 files · ~449,258 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5472 nodes · 8710 edges · 335 communities (219 shown, 116 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 609 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `79e64eb4`
...
- MainComponent::makeClipMediaDisposeHook
- MainComponent::makeCompositionResolver
- MainComponent::makeDeckActivateHook
...
1. `MainComponent` - 228 edges
2. `Renderer` - 187 edges
3. `ClipInspector` - 112 edges
4. `Clip` - 111 edges
5. `Layer` - 104 edges
6. `MilkDropBrowser` - 99 edges
7. `LayerInspector` - 92 edges
8. `BPMTracker` - 92 edges
...
- `advanceOneBeat()` --references--> `Autopilot`  [EXTRACTED]
  tests/test_autopilot.cpp → src/model/Autopilot.h
- `MainComponent` --defines--> `MainComponent::setTooltipsEnabled()`  [EXTRACTED]
  src/MainComponent.h → src/MainComponent.cpp
- `MainComponent` --defines--> `MainComponent::resized()`  [EXTRACTED]
  src/MainComponent.h → src/MainComponent.cpp

## Import Cycles
- None detected.

## Communities (335 total, 116 thin omitted)

### Community 0 - "MainComponent"
Cohesion: 0.01
Nodes (142): ApiServer, AudioDNALookAndFeel, AudioDNAMenuBar, AudioEngine, AudioReadoutPanel, BindingManager, BindingOverlay, BrowserPanel (+134 more)

### Community 1 - "Renderer"
Cohesion: 0.02
Nodes (95): EffectChainGLState, OpenGLContext, OpenGLRenderer, promise, GLuint, Image, ProceduralSource, SourceParam (+87 more)

### Community 2 - "Clip"
Cohesion: 0.03
Nodes (75): AlphaType, BlendOverride, LoopMode, MediaType, PlaylistCycleMode, PlaylistTrigger, Clip, alphaType (+67 more)
...
Cohesion: 0.03
Nodes (73): DragTarget, ClipInspector, anchorControl_, autopilotActionSelector_, autopilotDurationSelector_, beatDivisionLabel_, beatDivisionSelector_, beatSnapSelector_ (+65 more)
...
Cohesion: 0.03
Nodes (63): deque, PresetListContent, set, Slider, ComboBox, Component, function, JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (+55 more)

### Community 9 - "LayerInspector"
Cohesion: 0.08
Nodes (19): SettableTooltipClient, ClipCell, active_, clip_, column_, dragHover_, fxDragHover_, kNameBarHeight (+11 more)

### Community 10 - "TestServer"
Cohesion: 0.03
Nodes (64): ComboBox, Component, DragAndDropTarget, function, JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR, Label, MacroPanel, ResettableSlider (+56 more)

### Community 11 - "ProjectMPresetManager"
Cohesion: 0.03
Nodes (62): AutopilotAction, AutopilotDuration, AutoSizeMode, KeyingMode, MixMode, BeatSnapMode, EffectSlot, optional (+54 more)
...
Cohesion: 0.05
Nodes (48): PixelBuffer, AVCodecContext, AVFormatContext, AVFrame, AVPacket, AVStream, Config, File (+40 more)

### Community 15 - "CompDecksBrowser"
Cohesion: 0.12
Nodes (25): atomic, Category, ClipPositionSignal, FeatureSnapshot, Signal, unique_ptr, vector, Signal (+17 more)

### Community 16 - "vector"
Cohesion: 0.06
Nodes (28): CycleMode, FeatureSnapshot, PoolFilter, PresetInfo, string, vector, function, PoolFilter (+20 more)

### Community 17 - "TopBar"
Cohesion: 0.06
Nodes (44): CompDeckListContent, SavedEntry, CompDecksBrowser, CompDecksBrowser::CompDeckListContent, kEntryRowHeight, kSectionHeaderHeight, CompDecksBrowser::~CompDecksBrowser(), composition_ (+36 more)

### Community 18 - "ShaderManager"
Cohesion: 0.04
Nodes (53): array, ResettableSlider, ComboBox, Component, Composition, FeatureBus, function, JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (+45 more)
...
Cohesion: 0.04
Nodes (47): AutopilotDirection, AutopilotDurationMode, CrossfaderBehaviour, CrossfaderBlendMode, CrossfaderCurve, File, PerTypeAutopilotConfig, Composition (+39 more)

### Community 23 - "FXBrowser"
Cohesion: 0.06
Nodes (50): EffectRow, EffectScope, EffectSlot, Graphics, MouseEvent, SourceDetails, vector, EffectStackView (+42 more)
...
Cohesion: 0.04
Nodes (51): Binding, DeckActivateHook, Deck, function, Graphics, Image, MouseEvent, MainComponent::advanceSlideshow() (+43 more)
...
### Community 31 - "string"
Cohesion: 0.06
Nodes (25): iterator, Composition, Deck, string, vector, idsRetired(), playableClipIds(), remintClipIds() (+17 more)
...
Cohesion: 0.08
Nodes (35): AnalysisThread, Clip, Component, FeatureBus, GLuint, Image, ImageSequence, VideoPlayer (+27 more)
...
Cohesion: 0.08
Nodes (34): BindingOverlay, active_, BindingOverlay::BindingOverlay(), exitBindingMode, findExistingBinding, getKeyDescription, hitTestTarget, keyPressed (+26 more)
...
Cohesion: 0.13
Nodes (19): EffectChain, FeatureSnapshot, MappingCurve, MappingSource, vector, MappingEngine, addMapping, applyCurve (+11 more)
...
Cohesion: 0.07
Nodes (33): Component, File, Image, EffectChain, FeatureBus, File, Image, mutex (+25 more)
...
Cohesion: 0.14
Nodes (36): applyClipEffects, applyClipTransform, applyLayerKeying, applyLayerTransform, applyMaskLayer, applyScreenSplit, applyTransition, blendLayerOntoAccumulator (+28 more)
...
Cohesion: 0.11
Nodes (31): FeatureSnapshot, GLint, GLuint, OpenGLShaderProgram, unique_ptr, EffectChain, addEffect, applyDryWet (+23 more)
...
Cohesion: 0.15
Nodes (14): _arm_watchdog(), _default_app_bundle(), _health_ok(), _is_ours(), _process_info(), Event, Output-window LEVEL probe — regression guard for the "black overlay on every Spa, Arm a daemon thread that force-kills the app if the run wedges.      This is the (+6 more)
...
Cohesion: 0.26
Nodes (12): main(), _preflight(), ProbeBlocked, Verify the probe can actually measure before it opens a black window.      Retur, Run the probe. See the module docstring for exit codes., Raised when the measurement cannot be performed (exit 2)., Print a progress line to stderr, unbuffered., Run `open` on the bundle. Returns the stderr log path.      Uses `open --stdout/ (+4 more)

### Community 59 - "ClipInspector.cpp"
Cohesion: 0.07
Nodes (34): ClipDeckResolver, ClipLayerResolver, ClipMediaDisposeHook, ClipMediaHook, DeckFenceHook, function, optional, string (+26 more)

### Community 60 - "ax_inspector.py"
Cohesion: 0.06
Nodes (52): AccessibilityPermissionError, AppNotFoundError, AXInspectorError, check_accessibility_permissions(), find_pid_by_name(), _get_ax_attribute(), _get_position(), _get_size() (+44 more)
...
Cohesion: 0.08
Nodes (24): SignalInspector, Component, Composition, JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR, Tab, TextButton, InspectorPanel, activeTab_ (+16 more)
...
Cohesion: 0.08
Nodes (14): cancelPendingTriggers(), deckResolver_, Deck, id, kDefaultColumns, kDefaultLayers, layers, name (+6 more)
...
Cohesion: 0.15
Nodes (14): DeckView, function, DeckView, Composition, Deck, Renderer, UndoService, composition_ (+6 more)
...
Cohesion: 0.11
Nodes (18): DialogWindow, Component, function, Graphics, Rectangle, String, JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR, PreferencesDialog (+10 more)

### Community 78 - "MacroPanel"
Cohesion: 0.06
Nodes (45): AddDeckCmd, added_, addedIndex_, cancelledOnAdd_, compResolver_, fence_, priorActiveIndex_, AddLayerCmd (+37 more)
...
Cohesion: 0.07
Nodes (35): Param, FeatureSnapshot, GLuint, OpenGLShaderProgram, string, GLuint, string, vector (+27 more)
...
Cohesion: 0.08
Nodes (28): Macro, MacroSlot, Scope, array, SignalRegistry, MacroBank, kNumMacros, macros_ (+20 more)
...
Cohesion: 0.16
Nodes (13): Entry, Key, KeyHash, list, File, Image, Time, unordered_map (+5 more)
...
Cohesion: 0.10
Nodes (21): Kind, EffectStackCmd, after_, before_, compResolver_, fence_, refresh_, scope_ (+13 more)
...
Cohesion: 0.15
Nodes (10): applyPendingTriggerCancellation(), Composition, RemoveDeckCmd, compResolver_, deckIndex_, disposeHook_, mediaHook_, priorActiveIndex_ (+2 more)

### Community 103 - "AudioDNAMenuBar"
Cohesion: 0.22
Nodes (10): Clip, MacroBank, MacroPanel, optional, SignalRegistry, UniversalParamControl, vector, Composition (+2 more)
...
Cohesion: 0.08
Nodes (34): GLState, string, mutex, ProjectMPresetManager, string, vector, ProjectMSource, ProjectMSource::applyParams() (+26 more)
...
Cohesion: 0.10
Nodes (31): buildSourceParamControls, ClipInspector::ClipInspector(), getPreferredHeight, isInterestedInDragSource, itemDragEnter, itemDragExit, itemDropped, mouseDown (+23 more)
...
Cohesion: 0.67
Nodes (3): KeyPress, Component, MainComponent::keyPressed()

### Community 113 - "UndoService"
Cohesion: 0.09
Nodes (16): ClearLayerClipsCmd, after_, before_, deckIndex_, disposeHook_, fence_, layerIndex_, mediaHook_ (+8 more)

### Community 114 - "OscillatorSignal"
Cohesion: 0.16
Nodes (18): EffectScope, Layer, SourceDetails, getPreferredHeight, isInterestedInDragSource, itemDragEnter, itemDragExit, itemDropped (+10 more)
...
Cohesion: 0.16
Nodes (14): fileDragEnter, fileDragExit, isInterestedInDragSource, isInterestedInFileDrag, itemDragEnter, itemDragExit, resized, setActive (+6 more)

### Community 120 - "test_range_quality.py"
Cohesion: 0.12
Nodes (13): BiquadState, BiquadState, vector, LoudnessAnalyzer, fillCount_, process, processBiquad, runningSum_ (+5 more)
...
Cohesion: 0.16
Nodes (15): BindableTarget, CellEdit, optional, File, vector, MainComponent::appendDeckFromFile(), MainComponent::applyFileDrop(), MainComponent::applyMultiFileDrop() (+7 more)
...
Cohesion: 0.40
Nodes (5): Clip, EffectScope, Layer, inspectClip, inspectLayer
...
Cohesion: 0.19
Nodes (10): applyFXOnlyLayer, updateFeedbackBuffer, FullscreenQuad, draw, init, initialized_, release, vao_ (+2 more)

### Community 135 - "LayerStrip.cpp"
Cohesion: 0.16
Nodes (13): Graphics, clearSelection, getNaturalHeight, layoutGrid, onDeckSwitched, paint, refresh, resized (+5 more)
...
Cohesion: 0.14
Nodes (18): CompositionInspector::CompositionInspector(), getPreferredHeight, isInterestedInDragSource, itemDragEnter, itemDragExit, itemDropped, rebuildEffectStack, refresh (+10 more)
...
Cohesion: 0.22
Nodes (11): Command, MidiOutputHandler, String, unique_ptr, currentMidiOutputDeviceId(), MainComponent::handleMenuCommand(), MainComponent::loadMilkDropPresetDirSetting(), MainComponent::makeSetClipCmd() (+3 more)
...
Cohesion: 0.22
Nodes (11): filesDropped, itemDropped, onClipMove, onEffectDrop, onFileDrop, onMilkDropDrop, onMilkDropPlaylistDrop, onMixedFilesDrop (+3 more)

### Community 152 - "BrowserPanel.cpp"
Cohesion: 0.10
Nodes (9): Command, description, execute, undo, CompositeCommand, children_, string, unique_ptr (+1 more)

### Community 153 - "string"
Cohesion: 0.10
Nodes (13): atomic, FeatureBus, Thread, unordered_map, Array, SignalRegistry, string, vector (+5 more)

### Community 154 - "Smoother"
Cohesion: 0.09
Nodes (26): applyLayerRuntime(), captureLayerClips(), captureLayerRuntime(), ClearActiveClipCmd, after_, before_, deckIndex_, layerIndex_ (+18 more)
...
Cohesion: 0.19
Nodes (14): _close_output_window(), _find_app_pids(), _pgrep(), _process_alive(), Whether a PID is still running (EPERM counts as alive)., Run pgrep and return the matching PIDs (empty list on no match).      pgrep read, Every live Audio-DNA process, by three independent mechanisms.      NSWorkspace, SIGTERM then SIGKILL the app, bounded. Returns a state description.      Used bo (+6 more)
...
Cohesion: 0.26
Nodes (12): InspectorPanel, Signal, Tab, InspectorPanel::InspectorPanel(), inspectSignal, refresh, resized, setActiveTab (+4 more)

### Community 161 - "LayerStrip::LayerStrip"
Cohesion: 0.15
Nodes (13): Composition, FeatureBus, handleMultiplierButton, onBpmMultiplierChanged, onLinkToggled, onManualBpmChanged, onPause, onPlay (+5 more)
...
Cohesion: 0.29
Nodes (10): string, vector, buildPlaylistDragDescription, calculateContentHeight, getCuratedPresets, getPresetsForSection, getSelectedPresetPaths, parseDragDescription (+2 more)

### Community 166 - "ClipPositionSignal"
Cohesion: 0.31
Nodes (11): ProceduralSource, SourceParam, string, vector, compileShaderWithUtils, getOrCreateSource, getOrCreateSourceOnGLThread, renderSource (+3 more)
...
Cohesion: 0.20
Nodes (12): _describe_pid_windows(), _find_output_windows(), _measure(), _open_output_window(), Open the output window on the main display and assert its level., Find the output window(s): exact title match AND owned by `pid`.      Matching o, Poll until the output window appears, or `timeout` elapses., Poll until no output window owned by `pid` is on screen. (+4 more)
...
Cohesion: 0.15
Nodes (21): PlayMode, SubTab, addToRecent, firePresetSelected, getPlaylistBlendSeconds, getPlaylistCycleModeId, getPlaylistTriggerBeats, handlePresetClick (+13 more)
...
Cohesion: 0.33
Nodes (6): BeatSnapMode, QuantizeMode, FeatureSnapshot, MainComponent::handleClipTrigger(), MainComponent::handleColumnTrigger(), quantizeModeToForcedSnap()
...
Cohesion: 0.40
Nodes (5): FeatureSnapshot, vector, generateSine(), bpm, runPipeline()

### Community 196 - "TestEffects"
Cohesion: 0.33
Nodes (4): MacroBank, SignalRegistry, setMacroBank, setSignalRegistry
...
Cohesion: 0.18
Nodes (8): EffectChain, addTestEffect(), EffectChain, File, pair, String, vector, tempPresetFile()

### Community 202 - "drawSignalTriangle"
Cohesion: 0.67
Nodes (3): var, fromVar, toVar
...
Cohesion: 0.33
Nodes (7): isInThumbnailArea, mouseDown, mouseDrag, mouseUp, onTrigger, MouseEvent, Point

### Community 207 - "function"
Cohesion: 0.33
Nodes (6): _find_output_windows_any(), _onscreen_windows(), Snapshot every on-screen window, excluding desktop elements.      Returns:, Every on-screen window titled "Audio-DNA Output", whatever owns it.      The tea, Whether window titles are visible to this process at all.      macOS redacts kCG, _window_names_readable()

### Community 208 - "addParam"
Cohesion: 0.50
Nodes (3): fromVar, toVar, var

### Community 210 - "OutputRenderer::OutputRenderer"
Cohesion: 0.40
Nodes (5): FeatureSnapshot, FullscreenQuad, GLuint, ShaderManager, ProjectMSource::render()
...
Cohesion: 0.06
Nodes (40): Clip, ClipDeckResolver, ClipLayerResolver, ClipMediaDisposeHook, ClipMediaHook, Composition, CompositionResolver, Deck (+32 more)

### Community 214 - "setComposition"
Cohesion: 0.67
Nodes (3): vector, flatMagnitudeSpectrum(), sineMagnitudeSpectrum()

### Community 215 - "paint"
Cohesion: 0.67
Nodes (3): psnr(), Test if an effect with defaults produces visible change. Returns PSNR., test_effect()

### Community 217 - "setSignalRegistry"
Cohesion: 0.50
Nodes (4): _discover_main_fullscreen_item(), _pick_main_fullscreen_item(), Discover the 'Fullscreen: <W>x<H> (main)' item name from the live menu.      Tri, Pick the 'Fullscreen: <W>x<H> (main)' item out of the live menu.      Raises:

### Community 218 - "Deck"
Cohesion: 0.09
Nodes (17): Autopilot, CompositorEngine, EffectChain, EffectLibrary, MappingEngine, mutex, RoutingEngine, SignalRegistry (+9 more)

### Community 222 - ".getMenuBarModel"
Cohesion: 0.28
Nodes (5): Deck, FeatureSnapshot, advanceOneBeat(), Deck, FeatureSnapshot

### Community 225 - "attachTo"
Cohesion: 0.83
Nodes (3): BPMTracker, feedConstantBPM(), feedWithBeats()

### Community 230 - ".setEffectFenceHook"
Cohesion: 0.24
Nodes (6): AudioSignal, source_, Category, FeatureSnapshot, MappingSource, string

### Community 232 - "Component"
Cohesion: 0.32
Nodes (8): File, captureFrame, closeMediaForClip, getVideoPlayerFile, loadImage, openImageSequenceForClip, openVideoForClip, takeSnapshot

### Community 244 - ".remove_mapping"
Cohesion: 0.50
Nodes (5): getNameBarBounds, getThumbnailBounds, paint, Graphics, Rectangle

### Community 249 - "RouteTarget"
Cohesion: 0.29
Nodes (4): Composition, FeatureBus, string, FeatureSnapshot

### Community 259 - ".TestServer"
Cohesion: 0.40
Nodes (5): paint, paintSectionHeader, Graphics, Rectangle, String

## Knowledge Gaps
- **1659 isolated node(s):** `ProjectMSource`, `glContext_`, `quad_`, `shaderMgr_`, `texMgr_` (+1654 more)
...
- **Why does `MainComponent` connect `MainComponent` to `itemDropped`, `SignalInspector`, `MidiLearnOverlay`, `ProceduralSource`, `MilkDropBrowser`, `test_downbeat_detector.cpp`, `string`, `operator==`, `LoudnessAnalyzer`, `ShaderManager`, `verify_defaults.py`, `string`, `Deck`, `rebuildGrid`, `.fromVar`?**
  _High betweenness centrality (0.224) - this node is a cross-community bridge._
- **Why does `ThumbnailCache` connect `MappingEngine` to `string`, `SessionRecorder`, `getThumbnailBounds`, `string`?**
  _High betweenness centrality (0.150) - this node is a cross-community bridge._
- **Why does `Layer` connect `ProjectMPresetManager` to `ClipCell`, `BrowserPanel`, `fileListContent_`, `ProceduralSource`, `UniversalParamControl`, `drawSignalTriangle`, `BindingOverlay`, `AddDeckCmd`, `MacroPanel`, `EffectChainGLState`, `MidiOutputHandler`, `LayerStrip`, `EffectParam`, `Smoother`, `ClipInspector.cpp`, `.getMenuBarModel`, `SpectrumDisplay`, `test_fractals.py`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **What connects `ProjectMSource`, `glContext_`, `quad_` to the rest of the system?**
...
- **Should `Clip` be split into smaller, more focused modules?**
  _Cohesion score 0.025308641975308643 - nodes in this community are weakly interconnected._
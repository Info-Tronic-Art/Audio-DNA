...
## Corpus Check
- 270 files · ~401,957 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4973 nodes · 8007 edges · 241 communities (191 shown, 50 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 663 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0a1c882e`
...
- `deckResolverFor()` --references--> `UndoService`  [EXTRACTED]
...
## Communities (241 total, 50 thin omitted)

### Community 0 - "MainComponent"
Cohesion: 0.01
Nodes (146): AnalysisThread, ApiServer, Array, AudioDNALookAndFeel, AudioDNAMenuBar, AudioEngine, AudioReadoutPanel, BindingManager (+138 more)
...
Cohesion: 0.03
Nodes (87): Graphics, MouseEvent, Rectangle, SignalRegistry, SourceDetails, String, ComboBox, Component (+79 more)

### Community 10 - "ClipCell"
Cohesion: 0.08
Nodes (18): ClipCell, active_, clip_, column_, dragHover_, fxDragHover_, kNameBarHeight, layerIndex_ (+10 more)
...
Cohesion: 0.06
Nodes (34): ClipDeckResolver, ClipLayerResolver, ClipMediaHook, optional, string, SetClipCmd, after_, before_ (+26 more)
...
Cohesion: 0.08
Nodes (39): BindableTarget, Graphics, Image, KeyPress, MouseEvent, ClipDeckResolver, Component, CompositionResolver (+31 more)
...
Cohesion: 0.05
Nodes (55): map, BiquadState, BiquadState, vector, LoudnessAnalyzer, fillCount_, process, processBiquad (+47 more)
...
Cohesion: 0.07
Nodes (58): FeatureBus, AudioReadoutPanel, AudioReadoutPanel::AudioReadoutPanel(), displayBands_, displaySnap_, downbeatFlash_, drawBandMeters, drawBarIndicator (+50 more)

### Community 33 - "string"
Cohesion: 0.09
Nodes (28): Flag, applyLayerRuntime(), captureLayerClips(), captureLayerRuntime(), ClearActiveClipCmd, after_, before_, deckIndex_ (+20 more)
...
Cohesion: 0.14
Nodes (8): AnalysisThread::AnalysisThread(), getPCMSamples, getWaveformSamples, run, atomic, Thread, Array, Deck
...
Cohesion: 0.06
Nodes (30): Macro, MacroSlot, Scope, Composition, SignalRegistry, array, SignalRegistry, MacroBank (+22 more)
...
Cohesion: 0.11
Nodes (21): AddDeckCmd, added_, addedIndex_, compResolver_, fence_, priorActiveIndex_, AddLayerCmd, added_ (+13 more)
...
Cohesion: 0.21
Nodes (14): EffectScope, EffectStackCmd, after_, before_, compResolver_, refresh_, scope_, Composition (+6 more)
...
Cohesion: 0.09
Nodes (13): Composition, CompositionResolver, DeckActivateHook, SetColumnCountCmd, after_, before_, deckIndex_, deckResolver_ (+5 more)

### Community 64 - "StructuralDetector"
Cohesion: 0.05
Nodes (43): Composition, Graphics, PerformEditFn, SignalRegistry, Tab, Component, Composition, JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (+35 more)
...
Cohesion: 0.12
Nodes (23): ClipMediaHook, Command, DeckFenceHook, FeedbackConfig, optional, PresetEntry, SourceParam, T (+15 more)
...
Cohesion: 0.11
Nodes (17): ClearLayerClipsCmd, after_, before_, deckIndex_, layerIndex_, mediaHook_, resolver_, ClipMediaHook (+9 more)
...
Cohesion: 0.15
Nodes (9): Kind, EffectScope, column, deckIndex, kind, layerIndex, inspectClip, inspectLayer (+1 more)
...
Cohesion: 0.15
Nodes (12): applyClipTransform, applyMaskLayer, updateFeedbackBuffer, FullscreenQuad, draw, init, initialized_, release (+4 more)

### Community 110 - "LayerInspector.cpp"
Cohesion: 0.20
Nodes (13): ClipDeckResolver, ClipLayerResolver, DeckView, Composition, InspectorPanel, Renderer, UndoService, composition_ (+5 more)

### Community 111 - "test_effects.py"
Cohesion: 0.17
Nodes (13): fileDragEnter, fileDragExit, isInterestedInDragSource, isInterestedInFileDrag, itemDragEnter, itemDragExit, resized, setClip (+5 more)
...
Cohesion: 0.08
Nodes (17): Eyes Visual Tests — Render Pipeline  Tests the core rendering pipeline: image lo, Two effects chained should both apply., Verify audio feature injection works., Injecting features should succeed., Verify state endpoint works., State endpoint should list all effects., Verify reset clears state properly., After reset, no effects should be enabled. (+9 more)
...
Cohesion: 0.12
Nodes (28): Binding, CellEdit, DeckActivateHook, function, ClipLayerResolver, ClipMediaHook, Command, String (+20 more)
...
Cohesion: 0.15
Nodes (10): DeckView, InspectorPanel, ReinspectTarget, function, Clip, Deck, Layer, syncAfterModelChange (+2 more)
...
Cohesion: 0.18
Nodes (12): AudioEngine::AudioEngine(), getCurrentSampleRate, hasAudioDevice, isPlaying, loadFile, onError, pause, play (+4 more)

### Community 126 - "LayerStrip.cpp"
Cohesion: 0.21
Nodes (12): Clip, File, Layer, optional, applyFileDrop, fastSave, getFastSaveDir, handleFileDrop (+4 more)
...
Cohesion: 0.24
Nodes (10): filesDropped, itemDropped, onClipMove, onEffectDrop, onFileDrop, onMilkDropDrop, onMilkDropPlaylistDrop, onMultiFileDrop (+2 more)
...
Cohesion: 0.17
Nodes (14): Graphics, PopupMenu, Rectangle, String, buildSourcePickerMenu, drawSignalTriangle, getPreferredHeight, handleSourcePickerResult (+6 more)
...
### Community 218 - "ComboBox"
Cohesion: 0.67
Nodes (4): EffectChain, FeatureBus, OutputRenderer::OutputRenderer(), OutputWindow::OutputWindow()

### Community 219 - "FileDragAndDropTarget"
Cohesion: 0.50
Nodes (4): compResolverFor(), Composition, CompositionResolver, makeComp()

### Community 223 - "MenuBarModel"
Cohesion: 0.67
Nodes (3): BindingOverlay::BindingOverlay(), BindingManager, Composition

## Knowledge Gaps
- **1598 isolated node(s):** `scope_`, `before_`, `after_`, `composition_`, `renderer_` (+1593 more)
...
- **Why does `Renderer` connect `Renderer` to `DeckView`, `LayerStrip`, `SessionRecorder`, `MainComponent.cpp`, `PresetSelector`, `CompositorEngine.cpp`, `WaveformDisplay`, `ShaderManager`, `paint`, `setSignalRegistry`, `.inject_features`, `.add_route`, `FullscreenQuad`, `SpectrumDisplay`, `Image`, `SourceRegistry`, `SignalBar`, `ClearLayerClipsCmd`, `PreviewPanel`, `fileListContent_`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `FeatureSnapshot` connect `UniversalParamControl` to `DeckView`, `VideoRecorder`, `TestServer`, `LayerStrip`, `test_ax_inspector.py`, `Command`, `test_performance.py`, `ProjectMPresetManager`, `scan_all_presets.py`, `TextureManager`, `BindingManager`, `test_render_pipeline.py`, `Binding`, `ProceduralSource`, `WaveformDisplay`, `ShaderManager`, `MacroPanel`, `MFCCExtractor`, `FullscreenQuad`, `.stop`, `KeyDetector`, `Signal`, `vector`, `FFTProcessor`, `AudioDNAMenuBar`, `ClearLayerClipsCmd`, `SignalBar.cpp`, `fileListContent_`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `EffectLibrary` connect `SourceRegistry` to `StructuralDetector`, `Renderer`, `AudioDNAMenuBar`, `ApiServer`, `OutputRenderer::OutputRenderer`, `LayerInspector`, `MappingEditor`, `FullscreenQuad`, `CompositeCommand`, `test_range_quality.py`, `FXBrowser`, `LayerStrip`, `SourcesBrowser`, `FeedbackConfig`, `fileListContent_`, `Command`, `AdvancedAudioAnalyzer`, `AudioReadoutPanel`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **What connects `scope_`, `before_`, `after_` to the rest of the system?**
